...
data = open('photerr1.zout','r') # changed from photzerr.zout, reading from here to write to outfile and photest
...
outfile= open('outfilewerr.zout', 'w') #opening to write counter, diff68 and diff95
z_est= open('photestwerr.zout', 'w') # opening to write z_m2 separately
