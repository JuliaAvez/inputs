...
data = open('photznoerr.zout','r') # when you open a file, it becomes blank, so we open one that we do not write to
...
outfile= open('outfilenoerr.zout', 'w')
z_est= open('photestnoerr.zout', 'w') # opening to write z_m2 separately
