...
output_file = open('eazyerr4_CANDELS.cat','w')
...
for line in data.readlines():
    if not line.startswith(('#')):
        ...
        n_ctioU= (((fctioU*.06)**2)+(errctioU**2))**.5
        n_vimosU=(((fvimosU*.06)**2)+(errvimosU**2))**.5
        n_435=(((f435*.06)**2)+(err435**2))**.5
        n_606=(((f606*.06)**2)+(err606**2))**.5
        n_775=(((f775*.06)**2)+(err775**2))**.5
        n_850=(((f850*.06)**2)+(err850**2))**.5
        n_980=(((f980*.06)**2)+(err980**2))**.5
        n_1050=(((f1050*.06)**2)+(err1050**2))**.5
        n_1250=(((f1250*.06)**2)+(err1250**2))**.5
        n_1600=(((f1600*.06)**2)+(err1600**2))**.5
        n_isaack=(((fisaack*.07)**2)+(errisaack**2))**.5
        n_hawkk=(((fhawkik*.07)**2)+(errhawkk**2))**.5
        n_3600=(((f3600*.16)**2)+(err3600**2))**.5
        n_4500=(((f4500*.16)**2)+(err4500**2))**.5
        n_5800=(((f5800*.16)**2)+(err5800**2))**.5
        n_8000=(((f8000*.16)**2)+(err8000**2))**.5
